		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First Fiori",
									"targetURL": "#firstfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"firstfioriapp-display": {
								"semanticObject": "firstfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=firstfioriapp",
									"url": sap.ui.require.toUrl("firstfioriapp")
								}
							}
						}
					}
